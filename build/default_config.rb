...
@config[:simple_copies] = ["background/**/*", "css/viewer_manifest.css", "css/library.css", "fonts/**/*", "images/**/*", "manifest.json", "LICENSE", ]

# list of js libraries that need to be copied over (right now these are just simple copies)
@config[:js_libs] = ["lib/jquery-1.8.3.min.js", "lib/mathjax/**/*", "lib/pan_and_zoom.js", "scripts/libs/plugins.js", "scripts/libs/web_plugins.js", "lib/modernizr-2.5.3.min.js", "lib/utils/google_analytics_loader.js", "lib/2.5.3-crypto-sha1.js", "lib/images/*"]
